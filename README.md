...
[This exploration was performed in this Jupyter Notebook. There you will find the Python source code for all the graphs in this report.](https://github.com/elmunoz42/berkeley-aiml-coupon-analysis/blob/main/prompt.ipynb) Additionally, there are some custom Python functions imported into the notebook from the functions.py file, which is also in this repository.
